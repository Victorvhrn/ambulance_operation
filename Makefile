...
CPPLIB  	= -L$(GUROBI_HOME)/lib -lboost_program_options -lboost_system -pthread -lpthread -ldl \
			-lgurobi_c++ -lgurobi95 -L/usr/local/lib -losrm -lrt -lz -fuse-ld=gold \
			...
			-lboost_iostreams -lboost_thread -lboost_system -lpthread -ltbb -ltbbmalloc -lfmt
INCLUDE_DIR	= include
SRC_DIR		= src
OBJ_DIR		= obj
